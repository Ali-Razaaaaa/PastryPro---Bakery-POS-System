...
const Addcustomer = ({ setActiveComponent }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/customers/post', {
        method: 'POST',
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>
          Add <span style={styles.highlight}>Customer</span>
        </h2>
        <form onSubmit={handleSubmit}>
          {[
            ...
            <div style={styles.fieldContainer} key={idx}>
